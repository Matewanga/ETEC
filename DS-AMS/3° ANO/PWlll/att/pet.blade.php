...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="banco.php">Pet Shop</a>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="principal.php">Cadastrar Cliente</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">Cadastrar Pet</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <form>
                        ...
                        <div class="input-group">
                            <div class="input-box full-width">
                                ...
                                <textarea id="textarea1" name="textarea1" rows="3" placeholder="Descreva a doença"
                                    required></textarea>
                            </div>
                        </div>
