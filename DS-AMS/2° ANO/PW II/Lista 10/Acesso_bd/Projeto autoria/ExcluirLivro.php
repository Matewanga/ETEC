            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="ExcluirLivro.php">Excluir</a>
...
<form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <p>Código: <input name="ccod_livro" type="number" size="10" maxlength="8" placeholder="código do livro">
            <br><br>
