...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="pesquisarLivro.php">Pesquisa</a>
    ...
    <form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <p>Título: <input name="tituloo" type="text" size="25" maxlength="35" placeholder="Título do Livro">
            <br><br>
