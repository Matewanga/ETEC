            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="pesquisarAutor.php">Pesquisa</a>
...
<center><font face = "Century Gothic" size = "6"><b>Consulta de autores Cadastros</b><font size = "4">

<font face = "Century Gothic" size = "4"><b>
...
<form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            <legend><b> Informa o nome do autor desejado: </b></legend>
            <p>Nome: <input name="nomeautorr" type="text" size="30" maxlength="50" placeholder="Nome do autor">
            <br><br>
...
<fieldeset id="b">
    ...
    $p = new Autor();
    $p->setNomeautor($nomeautorr. '%');
    $pro_bd=$p->consultar();
    foreach($pro_bd as $pro_mostrar)
    {
        ?> <br>
        <b> <?php echo "Código do autor: " . $pro_mostrar[0]; ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
        <b> <?php echo "Nome do autor: " . $pro_mostrar[1]; ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
        <b> <?php echo "Sobrenome: " . $pro_mostrar[2]; ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
        <b> <?php echo "Email do autor: " . $pro_mostrar[3]; ?></b> &nbsp;&nbsp;&nbsp;&nbsp;
