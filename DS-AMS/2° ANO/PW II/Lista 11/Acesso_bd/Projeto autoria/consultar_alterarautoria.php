...
<body>
    <div class="container">
        ...
        <center><font face = "Century Gothic" size = "6"><b>Alteração de autoria Cadastradas</b><font size = "4">
...
<form name="cliente" method = "POST" action = "consultar_alterarautoria2.php">
        <fieldeset>
            ...
            <p>ID: <input name="ccod_autor" type="text" size="10" maxlength="5" placeholder="Id do autor">
            <br><br>
