            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="ExcluirAutor.php">Excluir</a>
...
<center><font face = "Century Gothic" size = "6"><b>Exclusão de Autor cadastrados</b><font size = "4">
...
<form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <p>Código: <input name="ccod_autor" type="number" size="10" maxlength="8" placeholder="Código do Autor">
            <br><br>
