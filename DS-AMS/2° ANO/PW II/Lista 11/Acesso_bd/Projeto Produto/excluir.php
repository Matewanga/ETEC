...
<center><font face = "Century Gothic" size = "6"><b>Exclusão de Produtos Cadastros</b><font size = "4">
...
<form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <p>ID: <input name="iid" type="text" size="20" maxlength="8" placeholder="ID do Produto">
            <br><br>
