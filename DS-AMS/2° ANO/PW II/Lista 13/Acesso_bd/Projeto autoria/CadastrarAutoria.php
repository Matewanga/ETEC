...
<body>
    ...
    <form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <div class="input-box">
            <input name="ccod_autor" type="text" size="10" maxlength="35" placeholder="código do autor">
            <i class="bi bi-123"></i>
            </div>
            <div class="input-box">
            <input name="ccod_livro" type="text" size="10" maxlength="35" placeholder="código do Livro">
            <i class="bi bi-123"></i>
            </div>
            <div class="input-box">
