...
<body>
    <div class="container">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="consultar_alterarlivro.php">Alterar</a>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <center>
                <font face="Century Gothic" size="6"><b>Alteração de Livros Cadastrados</b></font>
            ...
            <form name="cliente" method="POST" action="consultar_alterarlivro2.php">
                <fieldset>
                    ...
                    <p>ID: <input name="ccod_livro" type="text" size="10" maxlength="5" placeholder="Id do livro"></p> 
                    <div class="image-container">
                        <img src="Imagens/mudarr2.png" class="rounded float-end" alt="...">
