...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    ...
                    <a class="nav-link" href="banco.html">Home</a>
                        ...
                        <a class="nav-link active" aria-current="page" href="pesquisarAutoria.php">Pesquisa</a>
    ...
    <form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <p>Editora: <input name="editoraa" type="text" size="25" maxlength="35" placeholder="Nome da Editora">
            <br><br>
