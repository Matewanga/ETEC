...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="cadastrarAutor.php">Cadastrar</a>
                        ...
                        <a class="nav-link" href="consultar_alterarautor.php">Alterar</a>
                    </div>
                </div>
            </div>
        </nav>
    <form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <p>Nome do Autor: <input name="nomeautorr" type="text" size="50" maxlength="35" placeholder="Nome do autor">
            <p>sobrenome: <input name="sobrenomee" type="text" size="50" maxlength="35" placeholder="Sobrenome do Autor">
            <p>Email: <input name="emaill" type="email" size="80" maxlength="80" placeholder="Email do autor">
            <p>Nascimento: <input name="nascc" type="date" size="20" maxlength="80" placeholder="nascimento do autor">
</fieldeset>
<br>
<fieldeset id="b">
