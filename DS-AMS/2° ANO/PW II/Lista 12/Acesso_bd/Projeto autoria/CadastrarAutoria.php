...
<body>
    ...
    <form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            ...
            <p>Código do autor: <input name="ccod_autor" type="text" size="10" maxlength="35" placeholder="código do autor">
            <p>Código do livro: <input name="ccod_livro" type="text" size="10" maxlength="35" placeholder="código do Livro">
            <p>Editora: <input name="editoraa" type="text" size="80" maxlength="80" placeholder="">
            <p>Data de Lançamento: <input name="datalancamentoo" type="date" size="20" maxlength="35" placeholder="">
</fieldeset>
<br>
<fieldeset id="b">
