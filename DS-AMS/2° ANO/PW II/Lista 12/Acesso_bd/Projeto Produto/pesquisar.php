            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="pesquisar.php">Pesquisa</a>
                        <a class="nav-link" href="listar.php">Listar</a>
                        <a class="nav-link" href="consultar_alterar.php">Alterar</a>
                    </div>
                </div>
            </div>
        </nav>
<center><font face = "Century Gothic" size = "6"><b>Consulta de Produtos Cadastros</b><font size = "4">
...
<form name="cliente" method = "POST" action = "">
        <fieldeset id="a">
            <legend><b> Informa o nome do produto desejado: </b></legend>
            <p>Nome: <input name="name" type="text" size="30" maxlength="30" placeholder="Nome do Produto">
            <br><br>
