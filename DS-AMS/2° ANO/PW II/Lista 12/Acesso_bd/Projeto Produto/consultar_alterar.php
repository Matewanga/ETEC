            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a class="nav-link active" aria-current="page" href="consultar_alterar.php">Alterar</a>
                    </div>
                </div>
            </div>
        </nav>
<center><font face = "Century Gothic" size = "6"><b>Alteração de Produtos Cadastros</b><font size = "4">
...
<form name="cliente" method = "POST" action = "consultar_alterar2.php">
        <fieldeset>
            ...
            <p>ID: <input name="iid" type="text" size="10" maxlength="5" placeholder="Id do Produto">
            <br><br>
